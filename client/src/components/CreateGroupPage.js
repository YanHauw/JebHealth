...
export default class CreateGroupPage extends Component {
    ...
    handleCreate = async (event) => 
    {
        ...
        {
            document.getElementById('alert-green').innerHTML='Group size must be greater than 2!'
            document.getElementById('alert-green').style.width="20vw"
        ...
        else
        {
            ...
            if (res == 0)
            {
                document.getElementById('alert-green').innerHTML='Group created!'
